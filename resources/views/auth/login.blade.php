                        ...
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                <div class="form-group">
                                    <input id="email" type="email" name="email" placeholder="E-Mail" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
